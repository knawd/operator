...
# knawd.dev/knawd-operator-bundle:$VERSION and knawd.dev/knawd-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/knawd/operator
...
bundle: kustomize ## Generate bundle manifests and metadata, then validate generated files.
	...
	cd config/manager && $(KUSTOMIZE) edit set image controller=$(IMG)
	$(KUSTOMIZE) build config/manifests | operator-sdk generate bundle -q --overwrite --extra-service-accounts knawd-deployer-sa --version $(VERSION) $(BUNDLE_METADATA_OPTS)
